...
Based on our contextual interviews, the dashboard can be helpful 

Future work:

1. LLM-based user interface 
2. Develop side-by-side scenario comparison
3. Enhance simulation fidelity
